...
try {
    const res =await axios.get('/api/payments/get-plans',{headers:{
...
try {
    const res =await axios.put(`/api/payments/update-subscription/${id}`,{planId:planId,subscriptionId:subscriptionId},{headers:{
        token : "bearer "+ accesstoken
    }})
    if(findError(res.data)){
