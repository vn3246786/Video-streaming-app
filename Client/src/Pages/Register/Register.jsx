...
import { registerUser } from '../../Contexts/UserContext/apiCalls'
...
function onClickRegister(e){
  ...
  return (
    <div className='register'>
        <img className='background-image'src="src\Accets\best-fall-movies-1659459329 (2).jpg" alt="" />
        <form onSubmit={onClickRegister} encType='multipart/form-data' className="container">
            ...
            <img src={displayImage?URL.createObjectURL(displayImage):"src/Accets/451-4517876_default-profile-hd-png-download.png"} className='profile-image' alt="" />
            <input id='profilePic' type="file" accept='image'className='input-profile' ref={imageRef} name='profileImage' onChange={(e)=>setdisplayImage(e.target.files[0])}/>
            ...
            <input type="text" name='email'ref={emailRef} required  placeholder='Email' />
          ...
          {UserLoading&& <div className="spinner"><Oval color='red' secondaryColor='red'/></div>}
