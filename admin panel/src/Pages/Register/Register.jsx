...
function onClickRegister(e){
  ...
  return (
    <div className='register'>
        <img className='background-image'src="src\assets\best-fall-movies-1659459329 (2).jpg" alt="" />
        <form onSubmit={onClickRegister} encType='multipart/form-data' className="container">
            ...
            <img src={displayImage?URL.createObjectURL(displayImage):"src/assets/451-4517876_default-profile-hd-png-download.png"} className='profile-image' alt="" />
